...
public class MapperTest {
    ...
    public void mapTest() {
        ...
        MeasureDTO mesDT = MeasureMapper.INSTANCE.fromMeasure(measureGlobal, truck);

        assertEquals(measureGlobal.getCargoWeight(), mesDT.getCargoWeight());
        assertEquals(truck.getTruckNumber(),mesDT.getTruckNumber());
    }
